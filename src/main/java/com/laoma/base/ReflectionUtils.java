...
//                                      .toLowerCaseFirstOne(endName);
    ...
    public static void main(String[] a) {
        ...
        // Update u = ReflectionUtils.getUpdateObj(p);
        //        String ab="begin".substring(5);
        //        System.out.println("begin".substring(5));
        //        if (ab.isEmpty()) {
        //            System.out.println("aaa");
        //        }
        //        System.out.println(StringUtil.toLowerCaseFirstOne("ASSS"));
